...
export const auth = {
  ko: {
    ...
    apiKeyStoredBadge: '✓ 저장된 키 있음',
    apiKeyStoredPlaceholder: '저장된 키 유지 (변경하려면 입력)',
    apiKeyStoredHint: '비워두면 기존 키를 그대로 사용합니다. 새 키를 입력하면 교체됩니다.',
  ...
  en: {
    ...
    apiKeyStoredBadge: '✓ Key saved',
    apiKeyStoredPlaceholder: 'Keep saved key (enter to replace)',
    apiKeyStoredHint: 'Leave blank to keep your saved key. Enter a new key to replace it.',
