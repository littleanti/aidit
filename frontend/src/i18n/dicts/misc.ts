...
export const misc = {
  ko: {
    gemini_connected: 'AI 연결됨 — 최근 응답 성공',
    gemini_disconnected: 'AI 끊김 — 최근 응답 실패 (키/네트워크 확인)',
    gemini_unknown: 'AI 상태 미확인 — 아직 요청 없음',
  ...
  en: {
    gemini_connected: 'AI connected — last response succeeded',
    gemini_disconnected: 'AI disconnected — last response failed (check key/network)',
    gemini_unknown: 'AI status unknown — no requests yet this session',
