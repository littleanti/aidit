...
export default function PageHeaderBar({ children }: { children: ReactNode }) {
  return (
    <div className="sticky top-12 z-10 -mx-4 -mt-4 flex h-12 items-center gap-2 border-b border-term-border bg-term-screen/95 px-4 backdrop-blur desktop:mx-0 desktop:px-0">
      {children}
    </div>
  );
}
