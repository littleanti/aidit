...
자세한 사양은 [`docs/`](./docs)를 참조하세요: [PRD](./docs/PRD.md) · [TRD](./docs/TRD.md) · [PLAN](./docs/PLAN.md) · [WIREFRAME](./docs/WIREFRAME.md) · [디자인 시스템](./docs/DESIGN-SYSTEM.md)(로고 기반 컬러·타이포·로고 자산 SoT) · [구현 노트](./docs/IMPLEMENTATION_NOTES.md)(실제 구현 차이·추가·버그 수정·실행 방법).
